 ...
 * [wbphenotype.yml](wbphenotype.yml)
     * Determines how your purl.obolibrary.org/obo/wbphenotype/ redirects will be handled
     ...
     * Paste in the contents of [wbphenotype.yml](wbphenotype.yml)
 ...
 * [wbphenotype.md](wbphenotype.md)
     ...
     * Paste in the contents of [wbphenotype.md](wbphenotype.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
